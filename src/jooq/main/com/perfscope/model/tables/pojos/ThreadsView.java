...
public class ThreadsView implements Serializable {
    ...
    public ThreadsView(ThreadsView value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ThreadsView other = (ThreadsView) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ThreadsView (");

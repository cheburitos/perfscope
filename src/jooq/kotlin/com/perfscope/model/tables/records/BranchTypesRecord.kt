...
open class BranchTypesRecord() : UpdatableRecordImpl<BranchTypesRecord>(BranchTypes.BRANCH_TYPES) {
     ...
     * Create a detached, initialised BranchTypesRecord
     */
    constructor(value: com.perfscope.model.tables.pojos.BranchTypes?): this() {
        if (value != null) {
            this.id = value.id

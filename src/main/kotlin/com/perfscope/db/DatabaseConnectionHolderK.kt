...
class DatabaseConnectionHolderK(databasePath: String) : AutoCloseable {
    ...
    companion object {
        private val logger: Logger = LoggerFactory.getLogger(DatabaseConnectionHolderK::class.java)
    }
}